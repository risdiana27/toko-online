<?php
	...
	if($button =="Tambah"){
		...
		mysqli_query($koneksi, "UPDATE barang SET kategori_id='$kategori_id', nama_barang='$nama_barang', spesifikasi='$spesifikasi', stok='$stok', harga='$harga', status='$status' $update_gambar WHERE barang_id='$barang_id'");
	}
